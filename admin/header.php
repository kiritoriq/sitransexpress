...
<head>
  ...
  <title>SiTransExpress | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php?page=dashboard" class="logo">
      ...
      <span class="logo-mini"><b>SI</b>TEL</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SI</b> Trans Express</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/<?php echo $_SESSION['foto']; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['username']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/<?php echo $_SESSION['foto']; ?>" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="proses/logout.php" class="btn btn-danger btn-flat">Log out</a>
                </div>
              </li>
            </ul>
          </li>
